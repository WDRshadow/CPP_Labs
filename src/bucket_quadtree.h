...
#ifndef BUCKET_QUADTREE_H
#define BUCKET_QUADTREE_H
...
namespace alg
{
    ...
    public:
        ...
        QuadTree(const std::vector<Point>& points, int capacity, const Rectangle& rect) : rect(rect), points(points),
            capacity(capacity)
        {
            isLeaf = true;
        ...
        QuadTree(const std::vector<Point>& points, int capacity) : points(points), capacity(capacity)
        {
        ...
        void query(const Rectangle& rect, std::vector<Point>& result)
        {
    ...
    private:
        ...
        [[nodiscard]] bool check_intersect(const Rectangle& rect) const
        {
        ...
        [[nodiscard]] bool check_include(const Rectangle& rect) const
        {
